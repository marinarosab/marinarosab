...
- **Context:** Via NTT Data · Lisbon, Portugal

## Context

Caixa Geral de Depósitos is Portugal's largest state-owned bank, operating across retail, business and institutional banking. As a Scrum Master embedded via NTT DATA, I supported two squads working on distinct product and operational domains - each with its own ways of working, tooling, stakeholder landscape, and delivery challenges.

The environment was complex by nature: large organisation, multiple interdependencies, regulated sector, and a technology landscape that combined modern delivery practices with legacy processes and tooling. My role was to help each team work with more clarity, structure and visibility - without imposing a one-size-fits-all approach.

### Team 1 · Portais e Simuladores
This team is responsible for the digital portals and simulators used across CGD's customer-facing and internal channels.

#### What I worked on:
- **Roadmap visibility in Confluence:** The team's roadmap existed in fragments - spread across emails, meetings and informal conversations. I structured it in Confluence so that every theme, initiative and delivery had a home, was clearly described, and was visible to everyone who needed it: the team, the Product Owner, the stakeholders, the directors.

- **Connected ecosystem - Confluence → Jira → Triskell:** One of the key contributions in this team was creating a coherent information architecture across three tools. Work items in Confluence were linked to their corresponding Themes and Epics in Jira, which were in turn connected to the portfolio-level tracking in Triskell. This meant that progress could be followed at any level - from a single User Story up to a programme-level view - without duplicating information or losing traceability.

- **Epic and User Story structure:** I supported the definition and cascading of Epics in Jira, ensuring that each Epic connected meaningfully to the roadmap themes above it and to the User Stories below it. Each User Story was written with:
- A clear description from the user's perspective.
- Acceptance criteria that the team could verify.
- Functional and technical test cases defined before development started.
