...
- [ ] The Feature behaves as described in the original scope — no known gaps between what was agreed and what was built
...
2. **Make it visible.** Pin it to the team's board, add it to Confluence, put it in the sprint planning template. A DoD that lives only in a document nobody opens does not exist.
